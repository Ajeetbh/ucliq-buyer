...
const SixthSection = () => {
  return (
    <div className="container">
        <h1 style={{color:"#af1212",fontSize:"3rem"}}>How to register as a Buyer?</h1>
        <div className="flex-container">
            <div className="divcol2" data-aos="zoom-in">
                <h5>Download Ucliq <br/> Buyer App</h5>
                <a href="https://play.google.com/store/apps/details?id=com.ucliq_customer&gl=US" target="_blank"
                rel="noreferrer">
