  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        digitalizing 25% of traditional supply chains, it is currently operating
        in Delhi/NCR. UcliQ connects farmers, manufacturers, producers and
        wholesalers with retailers, kirana stores, cafes and restaurants,
        thereby helping local sellers to expand their businesses without having
        to worry about the hassles involved in the supply chains. With UcliQ,
        businesses can :<br />
        ...
        <span>BUY & SELL</span>
        <br />
        If you want to buy or sell, UcliQ is just a click or a phone call away!
        It provides hassle-free and timely pickup and delivery, to ensure your
        ...
        delivery team. On-time delivery and reduction of wastage are its topmost
        priorities. M<br />
        <span>BEST RATES</span>
        <br />
        UcliQ enables transparency along the entire supply chain. Real time data
        on prices mean you get the best deals and timely, online methods of
        payment ensures safe and smooth transactions for all parties involved.
      </p>
    </div>
  );
};
